...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2019"), "Partiu Viagem", "Vou viajar para Cuiaba, abraços", bruna);
		Post post2 = new Post(null, sdf.parse("22/03/2019"), "Feliz", "Bom dia, acordei feliz hoje!", bruna);
